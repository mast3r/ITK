...
{
  const FeaturePointsType::PointsContainer *points = this->GetFeaturePoints()->GetPoints();

  DisplacementsPointer displacements = this->GetDisplacements();
  DisplacementsType::PointsContainerPointer
  ...
  SimilaritiesType::PointsContainerPointer
    similaritiesPoints = SimilaritiesType::PointsContainer::New();
  SimilaritiesType::PointDataContainerPointer
